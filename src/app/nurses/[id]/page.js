            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 text-sm font-bold">
                <span className="flex items-center text-gray-600 bg-gray-50 px-4 py-2 rounded-xl">
                  <MapPin className="w-4 h-4 mr-2 text-gray-400" /> {nurseData.location || nurseData.district || "Location not set"}
                </span>
                          ...
                          {patientActiveCases.map(job => (
                            <label key={job.id} className={`flex items-start p-4 border-2 rounded-xl cursor-pointer transition ${selectedCaseId === job.id ? 'border-emerald-500 bg-emerald-50' : 'border-gray-100 hover:border-emerald-200 hover:bg-gray-50'}`}>
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500 font-medium">{job.careType} • {job.location}</p>
                              </div>
                            </label>
                          ))}
                        </div>
