              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-6 mb-6">
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <p className="flex justify-between items-start">
                      <span className="text-gray-500 font-medium shrink-0 mr-4">Location</span> 
                      <span className="font-bold text-gray-900 text-right capitalize">
                        {patientData.location?.street ? `${patientData.location.street}, ${patientData.location.city}` : 'Not provided'}
                      </span>
                    </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-50">
                <div>
                  ...
                  <p className="font-bold text-gray-700 capitalize">
                    {jobData.location?.city ? `${jobData.location.city}, ${jobData.location.zipCode}` : 'Local Area'}
                  </p>
                </div>
                <div>
